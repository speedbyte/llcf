...
//
// $Id: pcan_main.h 451 2007-02-02 10:09:50Z ohartkopp $
//
//****************************************************************************
...
#include <src/can.h> /* temporary ARPHRD_CAN is also defined here */
#include <src/error.h>
#endif
...
struct pcanctx_rt
{
  ...
  rtdm_lock_t       lock;                                  // mutual exclusion lock
  rtdm_event_t      in_event;
  rtdm_event_t      out_event;
  rtdm_event_t      empty_event;
  rtdm_mutex_t      in_lock;                               // read mutual exclusion lock
  rtdm_mutex_t      out_lock;                              // write mutual exclusion lock
